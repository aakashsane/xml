...
XML_FILE=OMIP4_CORE2.xml #OMIP4_CORE2.xml                   #The xml to test
RELEASE='xanadu'                 #The FMS release to test
MOM6_DATE='devgfdl_20190411'                     #The MOM6 tag date to test
...
EXPERIMENT_LIST="OM4p25_IAF_BLING_CFC_csf OM4p5_IAF_BLING_CFC_abio_csf_mle200 OM4p125_IAF_csf_CORE2_r5"
# OM4p5_IAF_BLING_CFC_abio_csf_mle200 OM4p25_IAF_BLING_CFC_csf"
...
FRERTS_ARGS="--no_rts,--fre_ops,-u;--no-transfer;--no-combine-history,--do_frecheck,--reference_tag,${REFERENCE_TAG}" 
