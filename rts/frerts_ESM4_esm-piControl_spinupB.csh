...
XML_FILE=ESM4_esm-piControl_spinupB.xml    #The xml to test
...
EXPERIMENT_LIST="ESM4_esm-piControl_spinupB"

DEBUGLEVEL='_0'
PLATFORM="ncrc4.intel16"
TARGET="prod-openmp"
REFERENCE_TAG='pre_xanadu_esm4_20180729_mom6_2018.04.11_answers'
...
#FRERTS_ARGS="--compile,-l,esm4.1_libs_compile,--no_rts,--fre_ops,-r;basic;-u;--no-transfer;--no-combine-history,--do_frecheck,--reference_tag,${REFERENCE_TAG}" 
